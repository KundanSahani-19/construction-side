...
const labourAssignmentRoutes = require(
  "./routes/labourAssignmentRoutes"
);
...
const labourTransferRoutes = require(
  "./routes/labourTransferRoutes"
);

const coupleRoutes = require(
  "./routes/coupleRoutes"
);

const coupleAttendanceRoutes = require(
  "./routes/coupleAttendanceRoutes"
);

const measurementRoutes = require(
  "./routes/measurementRoutes"
);
...
app.get(
  ...
  (req, res) => {
    ...
    res.json({
      ...
      message:
        "Construction Side API is running 🚀",
